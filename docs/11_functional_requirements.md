...
| FR-SCH-03 | สร้าง/ปิด slot | แพทย์/เจ้าหน้าที่/แอดมิน | เพิ่ม service และสร้าง slot ทีละรอบแบบ manual (จ.–ศ. 08:30–16:30 เว้นพักเที่ยง) | ตรวจเวลาไม่ทับซ้อนกับรอบเดิม ไม่ใช้วันในอดีต และไม่ใช้ template อัตโนมัติ | ช้อป |
| FR-SCH-04 | ความจุและการแก้ slot | ระบบ/แพทย์/เจ้าหน้าที่ | ตรวจจำนวนจองไม่เกินความจุ และควบคุมการแก้ไข slot ที่มีคนจอง | หาก bookedCount > 0 ปิดรับเพิ่มได้ แต่ห้ามแก้เวลาตรวจ และลดความจุต่ำกว่าจองไม่ได้ | ช้อป/ปาย |
