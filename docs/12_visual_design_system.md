...
### ภาพพื้นหลังหน้า Authentication

- หน้าเข้าสู่ระบบ สมัครสมาชิก ลืมรหัสผ่าน และตั้งรหัสผ่านใหม่ ใช้ภาพสีน้ำ `public/images/auth-care-watercolor.webp` ร่วมกันผ่าน auth layout
- ภาพเล่าลำดับลงทะเบียน ปรึกษา ตรวจวินิจฉัย และฟื้นฟู โดยเว้นพื้นที่ภาพให้ฟอร์มอ่านง่าย และปรับ overlay ตาม brand tokens ที่รองรับ light/dark theme
- Auth layout ไม่บังคับความสูงเต็ม viewport; พื้นหลังแบบ fixed อยู่ใต้ footer หลัก เพื่อให้ footer ต่อจากเนื้อหาและมองเห็น/เลื่อนถึงได้
- บนมือถือภาพยึดด้านซ้ายเพื่อให้ยังเห็นฉากการดูแล โดยฟอร์มคงลำดับและการทำงานเดิม
