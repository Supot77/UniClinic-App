...
สถานะ 20 กันยายน 2569: งานเอกสารรอบนี้ไม่แก้ UI code. Scheduling และ Herb dashboard ยังมีรายการ UI polish ตาม owner views; การตรวจ browser 360px/1280px, keyboard, loading/empty/error ยังต้องทำแยก
