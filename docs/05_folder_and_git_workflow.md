...
ทุกโมดูลใช้ role กลางชุดเดียว: `patient`, `medical` (แพทย์/เภสัชกร โดยแพทย์บันทึกวันลาของตนเองได้) และ `staff_admin` (เจ้าหน้าที่/แอดมิน)
...
- ก่อนรวม main ต้องผ่าน lint, typecheck, build และกรณีทดสอบหลัก; AC01–AC22 รวม database integration/RLS ต้องผ่านก่อนนำเสนอ
