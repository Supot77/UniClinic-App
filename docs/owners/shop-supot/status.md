...
- ฟอร์มเพิ่มและแก้ไขแผนก แพทย์ และบริการบน `/departments` เปิดเป็น modal กลางจอ ใช้ theme tokens สำหรับ light/dark และรองรับ Escape, focus trap, ปิดฉากหลัง และคืน focus
