...
- หน้าจัดการแผนก แพทย์ และบริการมีแท็บ catalog บริการสำหรับเจ้าหน้าที่ ไม่มีแท็บบัญชีผู้ป่วย
- ฟอร์มเพิ่มและแก้ไขแผนก แพทย์ และบริการบน `/departments` เปิดเป็น modal portal ลอยกลางจอ ใช้ theme tokens สำหรับ light/dark และรองรับ Escape, focus trap, ปิดฉากหลัง และคืน focus
- ช่องความเชี่ยวชาญแพทย์ค้นหาค่าที่มีอยู่และเพิ่มค่าใหม่ได้ โดยบันทึกลงฟิลด์ `specialty` เดิม
