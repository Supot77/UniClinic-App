...
1. ผู้ใช้เปิด flow บริการในหน้าตารางหรือหน้าจัดการของเจ้าหน้าที่
2. เพิ่มหรือแก้ code, ชื่อ และรายละเอียดบริการ หรือเปลี่ยนสถานะ
3. ระบบบันทึกผ่าน `/api/services`
...
2. ระบบตรวจวันทำการ เวลาเปิดคลินิก ช่วงพัก จำนวนจอง ความซ้ำซ้อน วันลา และสิทธิ์
...
**กรณีผิดพลาด:** วันหยุดสุดสัปดาห์ วันย้อนหลัง เวลานอกช่วง เวลาทับซ้อน วันลา หรือข้อมูลไม่ถูกต้อง ทำให้ระบบปฏิเสธการบันทึก
...
4. ระบบข้ามวันที่ลาและ slot ที่ขัดกัน แล้วรายงานจำนวนที่สร้าง
