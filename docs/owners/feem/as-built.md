...
| ค้นหาและแก้ข้อมูลผู้ป่วยตามสิทธิ์ | `/patients/search`, `/patients/[patientId]/edit` | `searchPatients`, `searchProfilesByGroup`, `getPatientForStaffAdmin`, `staffAdminUpdatePatient` | `PatientSearchContent`, migrations `08`, `18`, `19`, `21` | ทำแล้วใน code; ยังไม่ยืนยัน DB/RLS |
