...
/**
 * =============================================================================
 * ไฟล์: AddMedicationModal.tsx
 * =============================================================================
 * หน้าต่าง Modal สั่งจ่ายยาและกำหนดรอบเวลาเตือน (Prescribe Medication Modal)
 * สำหรับบุคลากรทางการแพทย์ (`medical`) หรือเจ้าหน้าที่ (`staff_admin`)
 * 
 * ส่วนประกอบภายในไฟล์นี้:
 * 1. ส่วนหัว Modal (Modal Header) - แสดงชื่อ Modal, ชื่อและรหัสผู้ป่วย, และปุ่มปิด (X)
 * 2. แถบเตือนประวัติการแพ้ยา (Allergy Warning Banner) - แถบสีแดงเตือนชื่อยาที่ผู้ป่วยแพ้
 * 3. ช่องเลือกยาที่แพทย์สั่งจ่าย (Prescribed Medications Dropdown) - แสดงเฉพาะยาจากใบสั่งแพทย์
 * 4. ช่องเลือกวิธีรับประทานกับมื้ออาหาร (Meal Timing Dropdown) - ก่อน/หลังอาหาร/พร้อมอาหาร/ก่อนนอน
 * 5. ตารางเลือกเวลารับประทานยา (Reminder Times Grid) - ปุ่มตาราง 4 รอบ (เช้า/กลางวัน/เย็น/ก่อนนอน)
 * 6. ช่องระบุวันที่เริ่มต้นและสิ้นสุด (Date Range Pickers) - วันเริ่ม และคำนวณวันสิ้นสุดอัตโนมัติ
 * 7. ปุ่มคำสั่ง (Action Buttons) - ปุ่มยกเลิก และปุ่มบันทึกการจ่ายยา (พร้อมระบบตรวจแพ้ยาก่อนส่ง)
 * =============================================================================
 */
