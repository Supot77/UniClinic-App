...
export function LandingActions() {
  ...
  return <div className="mt-7 flex flex-wrap items-center gap-3">
    ...
    <Link href={isAuthenticated ? "/schedules" : "/login?redirect=%2Fschedules"} className={`inline-flex min-h-12 items-center justify-center rounded-brand-button border border-brand-border-strong px-5 py-3 text-sm font-semibold hover:bg-white ${focus}`}>ดูตารางรอบบริการ</Link>
