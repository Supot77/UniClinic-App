-- Allow the owning medical user to approve or reject their own pending appointments.
-- staff_admin keeps the existing ability to decide any pending appointment.
BEGIN;
